...
2.	Comunicación activa: Mantendremos comunicación constante a través del medio definido (WhatsApp, correo, etc.) para informar avances o dificultades.
...
•	Hora: 20:30 – 22:00.
•	Lugar o medio: Google Meet o Microsoft Teams.
•	Organización de tareas:
o	Se asignarán tareas específicas a cada integrante en cada reunión.
o	Se llevará un registro de actividades mediante un tablero Kanban.
